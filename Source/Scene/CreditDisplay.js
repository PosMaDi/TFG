define([
    ...
    var cesiumLogo = buildModuleUrl('');// OMD
    var cesiumCredit = new Credit('<a href="https://cesiumjs.org/" target="_blank"><img src="' + cesiumLogo + '" title="CesiumJS"/></a>', false); // OMD
