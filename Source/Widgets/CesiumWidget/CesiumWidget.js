define([
            ...
            if (widget._useDefaultRenderLoop) {
                try {
                    ...
                    if (!defined(targetFrameRate)) {
                        widget.resize();
                        widget.render();
                        widget._scene.requestAnimationFrame(render); // OMD
                    } else {
    ...
    function configureCanvasSize(widget, width, height) { // OMD
    ...
    function configureCameraFrustum(widget, width, height) { // OMD
        // Fin OMD
        if (width !== 0 && height !== 0) {
    ...
    function CesiumWidget(container, options) {
        ...
        try {
            ...
            configureCameraFrustum(this, width, height); // OMD
